...
#ifndef _ENEMY_MISSILE_H_
#define _ENEMY_MISSILE_H_
...
//メンバ関数
public:
	EnemyMissile(){}		//デフォルトコンストラクタ

	//引数付きコンストラクタ
	EnemyMissile(DrawObject& pDrawObject, const D3DXVECTOR2& pos)
		:GameObject(pDrawObject, pos, D3DXVECTOR2(SIZE_X, SIZE_Y)), m_init_posx(pos.x) {}

	~EnemyMissile()override{}	//デストラクタ
