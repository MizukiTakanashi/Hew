//============================================================
// 土星の全てのゲームオブジェクトの当たり判定関係(cppファイル)
// 作成日：2022/1/17
// 作成者：高梨水希
//============================================================
...
// デフォルトコンストラクタ
//==========================
SaturnCollisionAll::SaturnCollisionAll()
{
...
// 引数付きコンストラクタ
//==========================
SaturnCollisionAll::SaturnCollisionAll(Player* pPlayer, inhPlayerArmBoth* pL, inhPlayerArmBoth* pR,
...
//================================================
int SaturnCollisionAll::Collision(void)
{
	//プレイヤー自身が受けたダメージ数
	int attacked = 0;
...
// プレイヤーのHPが回復する当たり判定
//=======================================
void SaturnCollisionAll::HeelCollision(void)
{
