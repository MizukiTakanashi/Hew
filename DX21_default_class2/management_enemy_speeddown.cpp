...
// 更新処理
//======================
void EnemySpeeddownManagement::Update(void)
{
	m_FlameNum++; //フレーム数を増加
...
// 描画処理
//==========================
void EnemySpeeddownManagement::Draw(void)const
{
	for (int i = 0; i < EnemyManagement::GetObjNum(); i++) {
		m_pEnemy[i].Draw();
	}
...
// 敵のHPを減らす
//======================
bool EnemySpeeddownManagement::ReduceHP(int index_num, int reduceHP)
{
...
// 敵を消す
//==========================
void EnemySpeeddownManagement::DeleteObj(int index_num)
{
	m_delete_enemy++;
	//敵を消す
...
// 弾を消す
//======================
void EnemySpeeddownManagement::DeleteBullet(int index_num)
{
